...
<div class="box" >
    <h3 >请输入邀请码</h3 >
    <input type="text" class="inputBox" id="accode" name="accode" value="" placeholder="请输入邀请码" />
</div >
...
<input type="hidden" value="<?php echo U('Mobile/Code/check');?>" id="ajaxUrl" >
</body>
...
<script src="/public/mobile/js/accode.js" ></script >
</html>