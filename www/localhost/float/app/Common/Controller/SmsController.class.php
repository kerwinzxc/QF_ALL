...
class SmsController extends AppframeController {
    ...
    private function send_aliyun_sms_code($phone, $code, $type) {
        ...
        include_once VENDOR_PATH.'aliyun/Dysmsapi/Request/V20170525/SendSmsRequest.php';
        include_once VENDOR_PATH.'aliyun/Dysmsapi/Request/V20170525/QuerySendDetailsRequest.php';
        // 获取阿里云短信配置信息
