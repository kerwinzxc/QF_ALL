...
//        $this->display();
    ...
    public function addtree() {
        ...
        $result = M('game_type')->where(array("parentid" => "0"))->order(array("listorder" => "DESC"))->select();
        foreach ($result as $r) {
    ...
    public function edittree() {
        ...
        $result = $this->gt_model->where(array("parentid" => "0"))->order(array("listorder" => "DESC"))->select();
        foreach ($result as $r) {
