...
<div class="wrap" >
    <ul class="nav nav-tabs" >
        <li ><a href="<?php echo U('Option/hsProduct');?>" >产品列表</a ></li >
        <li class="active" ><a href="<?php echo U('Option/hsProductRecord');?>?option_name=hs_product" >产品添加</a ></li >
    </ul >
    <form method="post" class="form-horizontal js-ajax-form" action="<?php echo U('Option/operationSetting');?>"
          enctype="multipart/form-data" >
        <fieldset >

            <input name="option_name" value="<?php echo ($_GET['option_name']); ?>" type="hidden"/>
            <input name="option_key" value="<?php echo ($_GET['key']); ?>" type="hidden"/>
            ...
            <div class="control-group" >
                <label class="control-label" >产品路径</label >
                <div class="controls" >
        ...
        <div class="form-actions" >
            ...
            <a class="btn" href="<?php echo U('Option/hsProduct');?>" ><?php echo L('BACK');?></a >
        </div >
    </form >
</div >
<script src="/public/js/common.js" ></script >
<script src="/public/js/previewImage.js" ></script >
</body >
</html>