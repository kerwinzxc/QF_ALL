...
<div class="wrap js-check-wrap" >
    <ul class="nav nav-tabs" >
        ...
        <li class="active" ><a href="<?php echo U('IosGame/delindex');?>" >删除列表</a ></li >
        <!--<li><a href="<?php echo U('IosGame/add');?>">添加游戏</a></li>-->
    </ul >

    <form class="well form-search" method="post" action="<?php echo U('IosGame/delindex');?>" >
    ...
    <form class="js-ajax-form" action="" method="post" >
        <table class="table table-hover table-bordered table-list" >
            ...
            <?php if(is_array($items)): foreach($items as $key=>$vo): ?><tr >
                    ...
                    <td >
                        <?php if($vo['is_delete'] == 1): ?><a href="<?php echo U('IosGame/restoreGame',array('id'=>$vo['id']));?>" class="js-ajax-dialog-btn"
