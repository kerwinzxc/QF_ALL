        ...
        <form method="post" class="form-horizontal js-ajax-form" action="<?php echo U('Game/addpackageurl_post');?>" >
            <fieldset >
                ...
                <div class="control-group" >
                    ...
                    <div class="controls" >
                        <label class="control-label"
                               style="text-align:left; width:800px" >下载服务器中的 sdkgame/<?php echo ($initial); ?> 目录上传母包,并改名为 <?php echo ($initial); ?>.apk</label >
                    </div >
                </div >
                ...
                <div class="control-group" >
                    ...
                    <div class="controls" >
                        <?php if(empty($games['packageurl'])): ?><label class="control-label"
                                   style="text-align:left; width:800px" >请上传母包<?php echo ($initial); ?>.apk</label >
                            <?php else: ?>
                            <label class="control-label"
                                   style="text-align:left; width:800px" ><?php echo DOWNSITE;?>/<?php echo ($games['packageurl']); ?></label ><?php endif; ?>
                    </div >
                </div >
            </fieldset >
