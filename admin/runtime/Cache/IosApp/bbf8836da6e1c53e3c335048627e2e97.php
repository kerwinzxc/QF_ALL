...
<div class="wrap js-check-wrap" >
    <ul class="nav nav-tabs" >
        <li class="active" ><a href="<?php echo U('IosApp/Version/index');?>" >APP版本列表</a ></li >
        <li ><a href="<?php echo U('IosApp/Version/add');?>" >添加APP版本</a ></li >
    </ul >

    <!-- 		<form class="well form-search" method="post"
                action="<?php echo U('IosApp/Version/index');?>">
            ...
            <?php if(is_array($versions)): foreach($versions as $key=>$vo): ?><tr >
                    ...
                    <td style="word-wrap:break-word;word-break:break-all;" >
                        <?php if(empty($vo['packageurl'])): ?>暂未上传app
                            ...
                            <?php else: ?>
                            <!--<?php echo ($vo["packageurl"]); ?>-->
                            <a href="<?php echo MOBILESITE;?>/mobile.php/mobile/game/app" ><?php echo MOBILESITE;?>/mobile.php/mobile/game/app</a ><?php endif; ?>
                    </td >
                    <td ><?php echo (format_file_size($vo["size"])); ?></td >
                    <td >
                        <?php if($vo['status'] == 1 OR $vo['status'] == 3): ?><a href="<?php echo U('Version/set_status',array('id'=>$vo['id'],'status'=>2));?>"
