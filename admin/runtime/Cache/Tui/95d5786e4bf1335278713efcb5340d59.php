...
<div class="wrap js-check-wrap" >
    <ul class="nav nav-tabs" >
        <li ><a href="<?php echo U('Tui/DataAgentReport/index');?>" target="_self" >全部渠道统计</a ></li >
        <li class="active" ><a href="#" target="_self" >按一级渠道统计</a ></li >
    </ul >
    <form class="well form-search" method="get" action='/admin.php/Tui/AgentData/report_agent.html' >
