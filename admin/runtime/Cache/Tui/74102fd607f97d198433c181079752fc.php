...
<div class="wrap js-check-wrap" >
    <ul class="nav nav-tabs" >
        <li class="active" ><a href="<?php echo U('Tui/Settle/check');?>" target="_self" >运营审核</a ></li >
    </ul >
    <form class="well form-search" method="get" action='/admin.php/Tui/Settle/operator_check/menuid/285.html' >
    ...
    <form class="js-ajax-form" action="" method="post" >
        <table class="table table-hover table-bordered table-list" >
            ...
            <?php if(is_array($items)): foreach($items as $key=>$vo): ?><tr >
                    ...
                    <td >
                        <?php switch($vo["status"]): case "1": ?><a href="<?php echo U('Tui/Settle/operator_pass',array('id'=>$vo['id']));?>"
                                   class="js-ajax-dialog-btn" data-msg="确定要设为审核通过吗？" >通过</a > |
                                <a href="<?php echo U('Tui/Settle/operator_notpass',array('id'=>$vo['id']));?>"
                                   class="js-ajax-dialog-btn" data-msg="确定要设为审核不通过吗？" >不通过</a ><?php break; endswitch;?>
                    </td >
