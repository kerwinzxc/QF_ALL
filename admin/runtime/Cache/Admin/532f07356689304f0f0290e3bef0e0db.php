    ...
    <form class="js-ajax-form" method="post" >
        <div class="table-actions" >
            <button class="btn btn-primary btn-small js-ajax-submit" type="submit"
                    data-action="<?php echo U('Admin/slide/listorders');?>" ><?php echo L('SORT');?>
            </button >
            <button class="btn btn-primary btn-small js-ajax-submit" type="submit"
                    data-action="<?php echo U('Admin/slide/toggle',array('display'=>1));?>" data-subcheck="true" ><?php echo L('DISPLAY');?>
            </button >
            <button class="btn btn-primary btn-small js-ajax-submit" type="submit"
                    data-action="<?php echo U('Admin/slide/toggle',array('hide'=>1));?>" data-subcheck="true" ><?php echo L('HIDDEN');?>
            </button >
            <button class="btn btn-primary btn-small js-ajax-submit" type="submit"
                    data-action="<?php echo U('Admin/slide/delete');?>" data-subcheck="true" ><?php echo L('DELETE');?>
            </button >
        </div >
        ...
        <table class="table table-hover table-bordered table-list" >
            ...
            <?php if(is_array($slides)): foreach($slides as $key=>$vo): ?><tr >
                    ...
                    <td >
                        <?php if(!empty($vo['app_id'])): echo ($games[$vo['app_id']]); ?>
                            <?php else: ?>
                            跳转到链接<?php endif; ?>
                    </td >
                    ...
                    <td >
                        ...
                        <a href="<?php echo U('Admin/slide/delete',array('id'=>$vo['slide_id']));?>"
                           class="js-ajax-delete" ><?php echo L('DELETE');?></a >
                        <?php if($vo['slide_status'] == 1): ?><a href="<?php echo U('Admin/slide/cancelban',array('id'=>$vo['slide_id']));?>"
                               class="js-ajax-dialog-btn" data-msg="确定显示此幻灯片吗？" ><?php echo L('DISPLAY');?></a >
                            <?php else: ?>
                            <a href="<?php echo U('Admin/slide/ban',array('id'=>$vo['slide_id']));?>" class="js-ajax-dialog-btn"
