...
<div class="wrap" >
    <ul class="nav nav-tabs" >
        ...
        <li class="active" ><a href="#" ><?php echo L('ADMIN_USER_EDIT');?></a ></li >
    </ul >
    <form method="post" class="form-horizontal js-ajax-form" action="<?php echo U('Admin/User/edit_post');?>" >
        <fieldset >
            ...
            <div class="control-group" >
                ...
                <div class="controls" >
                    <input type="password" class="input" name="user_pass" placeholder="******" >
                </div >
            </div >
            <div class="control-group" >
                <label class="control-label" >支付密码:</label >
                <div class="controls" >
                    <input type="password" class="input" name="pay_pwd" placeholder="******" >
                </div >
            </div >
            <div class="control-group" >
            ...
            <div class="control-group" >
                ...
                <div class="controls" >
                    <select name="cp_id">
                        ...
                        <?php if(is_array($cp_list)): foreach($cp_list as $k=>$vo): $company_checked=$vo['id']==$cp_id?"selected='selected'":""; ?>
                            <option value="<?php echo ($vo["id"]); ?>" <?php echo ($company_checked); ?>><?php echo ($vo["company_name"]); ?></option ><?php endforeach; endif; ?>
                    </select>
                </div >
            </div >
            <div class="control-group" >
