...
<div class="wrap js-check-wrap" >
    ...
    <form action="<?php echo U('Newapp/News/add_post');?>" method="post"
        ...
        <div class="row-fluid" >
            <div class="span9" >
                <table class="table table-bordered" >
                    ...
                    <tr >
                        ...
                        <td >
                            ...
                            <!-- <input type="text" name="gamename"
                                value="<?php echo ($gameinfo[gamename]); ?>"> -->
                        </td >
                    </tr >
                    ...
                    <tr >
                        <th width="80" >资讯类型</th >
                        <td >
                            <?php if(is_array($ptypes)): foreach($ptypes as $k=>$vo): $pt_select=$k==1 ?"checked":""; ?>
                                <label class="radio inline" for="active_true" >
                                    <input type="radio" name="post[post_type]" value="<?php echo ($k); ?>"
                                           <?php echo ($pt_select); ?> id="post[post_type]" /><?php echo ($vo); ?>
                    ...
                    <tr >
                        ...
                        <td ><input type="text" style="width: 400px;"
                                    ...
                                    placeholder="请输入标题" /> <span class="form-required" >*</span ></td >
                    </tr >
            ...
            <div class="span3" >
                <table class="table table-bordered" >
                    ...
                    <tr >
                        <td ><input type="text" name="post[post_modified]"
                                    value="<?php echo date('Y-m-d H:i:s',time());?>" class="js-datetime"
                    ...
                    <tr >
                        <td ><label class="radio" ><input type="radio"
                                                          name="post[post_status]" value="2" checked >审核通过</label >
                            <label
                                    class="radio" ><input type="radio"
                                                          name="post[post_status]" value="1" >待审核</label ></td >
                    </tr >
