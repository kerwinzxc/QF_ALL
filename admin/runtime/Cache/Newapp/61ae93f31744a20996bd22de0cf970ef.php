...
<body >
    <div class="wrap" >
        <ul class="nav nav-tabs" >
            ...
            <li ><a href="<?php echo U('Newapp/gametest/add');?>" >添加</a ></li >
            <li class="active" ><a href="/admin.php/Newapp/gametest/edit/id/4.html" >编辑</a ></li >
        </ul >
        <form action="<?php echo U('Newapp/gametest/editPost');?>" method="post" class="form-horizontal js-ajax-form" >
            <div class="row-fluid" >
                <div class="span9" >
                    <table class="table table-bordered" >
                        ...
                        <tr >
                            <th width="80" >开测描述</th >
                            <td >
                                <!--<script type="text/plain" id="content" name="testdesc"><?php echo ($data["testdesc"]); ?></script>-->
                                
                                <textarea name="testdesc"
                                          style='width:100%;height:200px;' > <?php echo ($data["testdesc"]); ?></textarea >
                            </td >
                        </tr >
                    </table >
                </div >
