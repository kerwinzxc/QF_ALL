...
<div class="wrap" >
    <ul class="nav nav-tabs" >
        ...
        <li class="active" ><a href="<?php echo U('Newapp/Gametype/add');?>" >添加游戏类型</a ></li >
    </ul >
    <form enctype="multipart/form-data" class="form-horizontal js-ajax-form" action="<?php echo U('Newapp/Gametype/add_post');?>"
          method="post" >
        <div class="row-fluid" >
            <div class="span9" >
                <table class="table table-bordered" >
                    ...
                    <tr >
                        <th >游戏类型名称</th >
                        <td >
                            <input type="text" name="gt_name" id="gt_name" value="" placeholder="" >
                        </td >
                    </tr >
                   ...
                   <tr >
                        ...
                        <td >
                               <div style="text-align: center;" >
                                <input type="hidden" name="gt_image" id="thumb" value="" >
                    ...
                    <tr >
                        <th >状态</th >
                        <td >
                            <label class="radio" ><input type="radio" name="gt_status" value="2" checked >显示</label >
