...
<body >
    <div class="wrap" >
        <ul class="nav nav-tabs" >
            ...
            <li class="active" ><a href="<?php echo U('Newapp/Gameserver/add');?>" >添加</a ></li >
        </ul >
        <form action="<?php echo U('Newapp/Gameserver/addPost');?>" method="post" class="form-horizontal js-ajax-form" >
            <div class="row-fluid" >
                <div class="span9" >
                    <table class="table table-bordered" >
                        ...
                        <tr >
                            <th width="80" >开服标识</th >
                            <td >
                                <input type='text' name='ser_code' class='form-control' />
                            </td >
                        </tr >
                        <tr >
                            <th width="80" >开服名称</th >
                        ...
                        <tr >
                            <th width="80" >开服状态</th >
                            <td >
                                <input type='radio' name='status' value='1' checked="checked" />预告                                
                                <input type='radio' name='status' value='2' />已开服
                            </td >
                        </tr >
                        <tr >
                            <th width="80" >开服描述</th >
                            <td >
                                <textarea name="ser_desc" style="width:500px;height:200px;" ></textarea >
                                <!--<script type="text/plain" id="content" name="ser_desc"></script>-->
                            </td >
                        </tr >
                    </table >
                </div >
