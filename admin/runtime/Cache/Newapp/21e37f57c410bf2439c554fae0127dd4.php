...
<div class="wrap js-check-wrap" >
    ...
    <button class="btn btn-success" onclick="location.href='<?php echo U('Newapp/Gametype/add');?>'"
            style="margin:10px 0;" >添加游戏类型
    </button >

    <form class="js-ajax-form" action="<?php echo U('Gametype/listorders');?>" method="post" >
        ...
        <table class="table table-hover table-bordered table-list" id="menus-table" >
            ...
            <!--            <?php if(is_array($gtypes)): foreach($gtypes as $key=>$vo): ?><tr >
                                ...
                                &lt;!&ndash; <td><img src=<?php echo ($vo["image"]); ?>  alt="图片为空" /></td> &ndash;&gt;
                                <td >
