...
<div class="wrap js-check-wrap" >
    ...
    <form class="well form-search" method="post"
		...
		游戏类型： <select class="select_2" name="gameclassify" id="gameclassify" >
        <?php if(is_array($gameclassify)): foreach($gameclassify as $k=>$vo): $pt_select=$k==$formget['gameclassify'] ?"selected":""; ?>
            <option value="<?php echo ($k); ?>" <?php echo ($pt_select); ?> ><?php echo ($vo); ?></option ><?php endforeach; endif; ?>
    </select >
        <br >
        <br >
    ...
    <form class="js-ajax-form" action="" method="post" >
        <button class="btn btn-primary btn-small js-ajax-submit" type="submit"
                data-action="<?php echo U('Newapp/News/settop',array('is_top'=>2));?>" data-subcheck="true" >置顶</button >
        <button class="btn btn-danger btn-small js-ajax-submit" type="submit"
            data-action="<?php echo U('Newapp/News/unsettop',array('is_top'=>1));?>"
