...
<body class="J_scroll_fixed" >
    <div class="wrap js-check-wrap" >
        <ul class="nav nav-tabs" >
            <li class="active" ><a href="<?php echo U('Newapp/gametest/index');?>" >开测列表</a ></li >
            <li ><a href="<?php echo U('Newapp/gametest/add');?>" >添加</a ></li >
        </ul >
        <form class="well form-search" method="get" id="cid-form" action='/admin.php/Newapp/Gametest/index.html' >
        ...
        <form class="js-ajax-form" method="post" >
            ...
            <table class="table table-hover table-bordered table-list" >
                ...
                <?php if(is_array($items)): $i = 0; $__LIST__ = $items;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr >
                        ...
                        <td ><?php echo ($vo["testdesc_striped"]); ?></td >
                        <td ><?php echo ($vo["start_time"]); ?></td >
                        <td ><?php echo ($vo["status_txt"]); ?></td >
                        <td >
                            <a href="<?php echo U('Newapp/gametest/edit',array('id'=>$vo['id']));?>" >编辑</a >
                            | 
                            <a href="<?php echo U('Newapp/gametest/deletePost',array('id'=>$vo['id']) );?>"
