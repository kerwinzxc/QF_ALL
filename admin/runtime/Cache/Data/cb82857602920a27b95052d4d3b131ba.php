...
<div class="wrap js-check-wrap" >
    ...
    <form class="well form-search" method="get" action="<?php echo U('Data/Retain/index');?>" >
        <div class="search_type cc mb10" >
            <div class="mb10" >
					<span class="mr20" >
						时间：
						<input type="text" name="start_time" class="js-date" value="<?php echo ((isset($start_time) && ($start_time !== ""))?($start_time):''); ?>"
                               style="width: 100px;" autocomplete="off" >-
						<input type="text" name="end_time" class="js-date" value="<?php echo ((isset($end_time) && ($end_time !== ""))?($end_time):''); ?>"
                               style="width: 100px;" autocomplete="off" > &nbsp; &nbsp;
