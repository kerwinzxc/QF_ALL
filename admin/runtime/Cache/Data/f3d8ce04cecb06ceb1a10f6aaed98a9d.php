...
<div class="wrap js-check-wrap" >
    ...
    <form class="well form-search" method="get" action="<?php echo U('Data/Member/dataindex');?>" >
        <div class="search_type cc mb10" >
            <div class="mb10" >
					<span class="mr20" >
						账号： 
						<input type="text" name="username" style="width: 200px;" value="<?php echo ($formget["username"]); ?>"
                               placeholder="请输入账号..." >
						&nbsp;&nbsp;
    ...
    <table class="table table-hover table-bordered table-list" >
        ...
        <tr >
            <!--<th>玩家ID</th> -->
            <th style='color:#FF0000' >玩家数量汇总</th >
            <th style='color:#FF0000' ><?php echo ($count); ?></th >
            <th >--</th >
            <th >--</th >
            <th >--</th >
            <th >--</th >
