...
<?php endswitch;?>
            ...
            <div class="page-right my-game query-records" >
                <form class="form-inline" role="form" id="queryForm" action="/agent.php/Agent/DataAgentForMem/all" method="get" >
                            ...
                            <div class="row" >
                                <!--                                <div class="col-xs-4">
                                                                    <div class="input-group">
                                                                        ...
                                                                        <input type="text" class="form-control" name="agent_name" value="<?php echo ($formget["agent_name"]); ?>" />
                                                                    </div>
                                                                </div>-->
                                <div class="col-xs-4" >
                                    <div class="input-group" >
                                        <span class="input-group-addon" >玩家帐号</span >
                                ...
                                <div class="col-xs-4" >
                                    <div class="input-group" >
                                        <span class="input-group-addon" >适用游戏 </span >
                ...
                <div class="search-results" >
                    ...
                    <div class="results-header" >
                        <span class="game-num" >共找到<i ><?php echo ($totalrows); ?></i >个记录</span >
                    </div >
...
<script >
    ...
    $(".charge_record_btn").click(function () {
        ...
        layer.open({
            ...
            shade     : 0.2,
            area      : ['850px', '60%'],
            content   : '<?php echo U("Agent/DataAgentForMem/index");?>?mem_id=' + mem_id //iframe的url
        });
    });
    ...
    $(".consume_record_btn").click(function () {
        ...
        layer.open({
            ...
            shade     : 0.2,
            area      : ['850px', '60%'],
            content   : '<?php echo U("Agent/DataMemConsume/index");?>?mem_id=' + mem_id //iframe的url
        });
    });
</script >