            ...
            <div class="page-right my-game query-records" >
                ...
                <div class="search-results" >
                    ...
                    <div class="results-header" >
                        <!--<span class="game-num">共找到<i><?php echo ($n); ?></i>个记录</span>-->
                    </div >
                    <div class="table-content registration-details" >
                        <table class="table table-hover table-bordered" >
                            ...
                            <?php if(is_array($items)): $i = 0; $__LIST__ = $items;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr >
                                    <td ><a href="<?php echo U('agent/news/viewItem');?>/id/<?php echo ($vo["id"]); ?>"
                                            style='text-decoration:none;' ><?php echo ($vo["post_title"]); ?></a ></td >
                                    <td style="width:150px;" ><?php echo (date("Y-m-d H:i:s",$vo["post_date"])); ?></td >
